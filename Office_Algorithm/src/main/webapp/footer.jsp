...
<br>
<br>
<div class="footer bg-darkest text-light">
    ...
    <div class='container' style="text-align: center">
        <img src="footer.jpeg" alt="Office Algorithm" style="width:500px; height:500x;"%>
        <br><br>
        <p><b><i><u>Contact</u></i></b></p>
        <p>Zachary Lorkiewicz</p>
        <p>Phone: <b>(978)660-3318</b></p>
        <p><b>zachary.lorkiewicz@gmail.com</b></p>
        <br>
